...
import time
import json
from app_usage import get_app_usage_instructions

# Streamlit page configuration
st.set_page_config(page_title="Exam Help Buddy", layout="wide")
...
st.subheader("Help & Usage Instructions")
with st.expander("Click to view how to use this app and what it can do"):
    st.markdown(get_app_usage_instructions())
